...
public class Automobile implements Runnable
{
    ...
    public Automobile(int id, double speed, String direction, FreewayRamp ramp, FreewaySegment freeway, JMapViewer map)
    {	
        ...
        this.ramp = ramp;
        this.map = map;
        currentLocation = ramp.getRampLocation();
        carsprite = new MapMarkerCircle(ramp.getRampLocation(), carradius);
    }
    public Automobile()
    {
    }
    ...
    public void setRamp(FreewayRamp ramp)
    {
        this.ramp = ramp;
    }
